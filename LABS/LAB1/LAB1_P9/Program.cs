...
namespace LAB1_P9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /* stephanie’s Confectionary wants a program that will prompt the user 
             * for the price of the candy and the amount of money she would like 
             * to spend and then calculates and display the amount of candies that 
             * can be purchased as well as the amount of money remaining after 
             * purchase. */
